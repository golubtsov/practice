    ...
    public function run(): void
    {
        ...
        $turs = [
            [
                ...
                'description' => 'Семь дней вдали от суеты, домашнего быта, работы и ежедневных забот помогут расслабиться, увидеть новые дали и ощутить легкость свободы, испытать радость от активного отдыха, стать ближе с родными, показать новый, еще неизведанный мир своим детям и понять, что возможно всё.',
                'price' => 12000
            ],
            [
                'adress_id' => 2,
